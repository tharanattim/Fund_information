...
<main>
		...
		<div class="card card-cascade narrower">
			...
			<div class="px-4 mb-2">
				<div class="table-wrapper ">
					<!--Table-->
					<table id="dtb_dept" class="table table-hover table-bordered" cellspacing="0" width="100%">
						<span class="table-add float-right mt-3 text-success">
							<i class="fas fa-plus fa-2x" aria-hidden="true" id="btn_add" title="เพิ่มข้อมูล" onclick="show_modalDept('')"></i>
						</span>
						<thead class="text-center">
						<tr>
							<th class="th-sm">รหัสแผนกงาน</th>
							<th class="th-sm">ชื่อแผนกงาน</th>
							<th class="th-sm">สถานะระบบ</th>
							<th class="th-sm">จัดการแผนกงาน</th>
						</tr>
						</thead>
	...
	<!-- Modal -->
	<div class="modal fade backdrop-color" id="modal_dept" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" data-backdrop="false" data-keyboard="false">
				...
				<div class="modal-c-tabs">
					...
					<div class="nav nav-tabs md-tabs gradient-card-header blue-gradient-invert lighten-1 py-3" role="tablist">
						<div class="col-sm-12 text-center">
							<h5 class="h2-responsive mb-0 text-white" id="lbl_modal">เพิ่มแผนกงาน</h5>
						</div>
					</div>
					<div class="container mb-3">
						<form class="needs-validation" id="form_dept"  style="color: #757575;" action="#!" novalidate>
						<div class="md-form">
							<input type="text" id="id" placeholder=" " class="form-control text-left">
							<label for="form1">รหัสแผนก</label>
						</div>
						<div class="md-form mb-3">
							<input type="text" id="name" placeholder=" " class="form-control text-left" required>
							<label for="form1">ชื่อแผนกงาน</label>
							<div class="invalid-feedback">
								กรุณากรอกชื่อแผนกงาน
							</div>
						</div>
						<div class="md-form mb-5" id="select_system_status">
							<select class="mdb-select" id="system_status" data-visible-options="-1">
								<option value="" disabled selected>เลือกสถานะระบบ</option>
							</select>
						</div>
						<div class="row">
							<div class="col-sm-6 col-6">
								<button type="button" class="btn btn-block btn-outline-success waves-effect" id="btn_save_department">บันทึก</button>
							</div>
...
<!-- Booking JavaScript -->
<script type="text/javascript" src="<?php echo base_url('assets/js/department.js')?>"></script>
