			...
			<div class="row">
				<div class="col-sm-12 col-xl-6">
					<div class="card card-cascade narrower">
						<div class="view view-cascade warning-color narrower py-3 mx-4 mb-4 white-text">
							<div class="row">
			...
			<div class="view view-cascade gradient-card-header blue-gradient narrower py-3 mx-4 mb-4">
				<div class="row">
					<div class="col-sm-6 text-left">
						<label>แผนกงานสำเร็จการศึกษา</label>
					</div>
...
<!-- Booking JavaScript -->
<script type="text/javascript" src="<?php echo base_url('assets/js/queue_dept_success.js')?>"></script>
