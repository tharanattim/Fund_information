...
<main>
		...
		<div class="card card-cascade narrower">
			...
			<div class="px-4 mb-2">
				<div class="table-wrapper">
					<!--Table-->
					<table id="dtb_systemStatus" class="table table-hover table-bordered" cellspacing="0" width="100%">
						<span class="table-add float-right mt-3 text-success">
							<i class="fas fa-plus fa-2x" aria-hidden="true" id="btn_add" title="เพิ่มข้อมูล" onclick="show_modalSystem('')"></i>
						</span>
						<thead class="text-center">
						<tr>
							<th class="th-sm">รหัสสถานะระบบ</th>
							<th class="th-sm">ชื่อสถานะ</th>
							<th class="th-sm">จัดการสถานะระบบ</th>
						</tr>
						</thead>
	...
	<!-- Modal -->
	<div class="modal fade backdrop-color" id="modal_system" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" data-backdrop="false" data-keyboard="false">
				...
				<div class="modal-c-tabs">
					...
					<div class="nav nav-tabs md-tabs gradient-card-header blue-gradient-invert lighten-1 py-3" role="tablist">
						<div class="col-sm-12 text-center">
							<h5 class="h2-responsive mb-0 text-white" id="lbl_modal">เพิ่มสถานะระบบ</h5>
						</div>
					</div>
					<div class="container mb-3">
						<form class="needs-validation" id="form_system" style="color: #757575;" action="#!" novalidate>
							<div class="md-form">
								<input type="text" id="id" placeholder=" " class="form-control text-left">
								<label for="form1">รหัสสถานะระบบ</label>
							</div>
							...
							<div class="row">
								<div class="col-sm-6 col-6">
									<button type="button" class="btn btn-block btn-outline-success waves-effect" id="btn_save_system">บันทึก</button>
								</div>
